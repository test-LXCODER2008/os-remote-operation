...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "你的桌面"),
        ("desk_tip", "欢迎使用小纯二次开源RustDesk此项目，小纯提示：打开软件前请您确保网络通畅！打开软件之后请把ID+密码发送或截图给我，之后请勿关闭软件，等待连接即可。"),
        ("Password", "密码"),
        ("Ready", "小纯服务端网络 就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 小纯服务端 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("About RustDesk", "关于 RustDesk（二次开发 By 小纯）"),
